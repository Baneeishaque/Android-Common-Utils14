...
public class DateUtils1 {
    ...
    public static Pair<Boolean, String> normalDateStringToMySqlDateString(String normalDateString) {
        ...
        try {
            ...
            if (normalDate != null) {
                ...
                return Pair.with(true, mySqlDateFormat.format(normalDate));

            } else {

                return Pair.with(false, "Normal Date is NULL");
            }
        } catch (ParseException parseException) {

            return Pair.with(false, ExceptionUtils1.getExceptionDetails(parseException));
        }
    }

    public static Pair<Boolean, String> normalDateTimeInWordsStringToMysqlDateTimeString(String normalDateTimeInWordsString) {
        ...
        try {
            ...
            if (normalDateTimeInWords != null) {
                ...
                return Pair.with(true, mySqlDateTimeFormat.format(normalDateTimeInWords));

            } else {

                return Pair.with(false, "Normal DateTimeInWords is NULL");
            }
        } catch (ParseException parseException) {
    ...
    public static Pair<Boolean, String> mySqlDateStringToNormalDateString(String mySqlDateString) {
        ...
        try {
            ...
            if (mySqlDate != null) {
                ...
                return Pair.with(true, normalDateFormat.format(mySqlDate));

            } else {

                return Pair.with(false, "MySQL Date is NULL");
            }
        } catch (ParseException parseException) {
    ...
    public static Pair<Boolean, String> mySqlDateTimeStringToNormalDateTimeString(String mySqlDateTimeString) {
        ...
        try {
            ...
            if (mySqlDateTime != null) {
                ...
                return Pair.with(true, normalDateTimeFormat.format(mySqlDateTime));

            } else {

                return Pair.with(false, "MySQL DateTime is NULL");
            }
        } catch (ParseException parseException) {
    ...
    public static Pair<Boolean, String> mySqlDateTimeStringToCustomDateTimeString(String mySqlDateTimeString, SimpleDateFormat customDateTimeFormat) {
        ...
        try {
            ...
            if (mySqlDateTime != null) {
                ...
                return Pair.with(true, customDateTimeFormat.format(mySqlDateTime));
    ...
    public static Triplet<Boolean, Date, String> mySqlDateTimeStringToCustomDateTime(String mySqlDateTimeString, SimpleDateFormat customDateTimeFormat) {
        ...
        try {
            ...
            if (mySqlDateTime != null) {
                ...
                return Triplet.with(true, customDateTimeFormat.parse(customDateTimeFormat.format(mySqlDateTime)), "");

            } else {

                return Triplet.with(false, customDateTimeFormat.parse(customDateTimeFormat.format(new Date())), "MySQL DateTime is NULL");
            }
        } catch (ParseException parseException) {
